...
class StatefulStompMessageProviderTest extends TestCase
{
    /**
    ...
    /**
     * @var StatefulStompMessageProvider
     */
    private $provider;
    ...
    public function setUp()
    {
        ...
        $this->protocol
            ->getSubscribeFrame('fake_destination', Argument::any(), 'fake_ack', 'fake_selector')
            ->willReturn($subscriptionFrame->reveal())
            ->shouldBeCalled();
        ...
        $this->provider = new StatefulStompMessageProvider(
            $this->client->reveal(),
            'fake_destination',
            'fake_selector',
            'fake_ack',
